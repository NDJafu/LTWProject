    ...
    <nav className="bg-white z-50">
      <div className="flex items-center font-medium md:justify-around md:px-0 px-4 justify-between">
        <div className="z-50 w-screen md:w-auto justify-between flex items-center border-b-1 border-gray-500">
          ...
          <Link to="/">
            <img src={Logo} alt="" className="md:cursor-pointer h-16" />
          </Link>
          <div>
            <MobileSearch />
          </div>
        ...
        <ul className="md:flex hidden uppercase items-center gap-8">
          <li>
            <Link to="/" className="md:cursor-pointer py-7 px-3 inline-block">
              Home
            </Link>
          </li>
          <NavLinks />
        ...
        {/*Mobile */}
        <ul
          className={`md:hidden bg-white uppercase fixed w-full h-full bottom-0 py-24 pl-8 duration-500 ${
